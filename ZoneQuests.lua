...
The Zones module creates, initializes, and updates the Quest Map quest by zone reference tables.  It provide the questId's and 
(x,y) locations of every quest available to a character whenever the character enters or accesses a game zone.  Note that you 
should not be able to see below ground (ie. dungeon) quests when you are on the surface.  To me, it's confusing... :)
